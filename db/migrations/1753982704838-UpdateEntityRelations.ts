...
export class UpdateEntityRelations1753982704838 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user" RENAME COLUMN "operator" TO "isOperator"`);
        ...
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "isOperator" SET DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "conversation" ALTER COLUMN "userId" DROP NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "conversation" ADD CONSTRAINT "FK_c3eb45de493217a6d0e225028fa" FOREIGN KEY ("roomId") REFERENCES "room"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "conversation" ADD CONSTRAINT "FK_308ba56d88a90fe50ea0f14b40f" FOREIGN KEY ("workerId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "conversation" DROP CONSTRAINT "FK_308ba56d88a90fe50ea0f14b40f"`);
        ...
        await queryRunner.query(`ALTER TABLE "conversation" ALTER COLUMN "userId" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "isOperator" DROP DEFAULT`);
        ...
        await queryRunner.query(`ALTER TABLE "conversation" ADD "room" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user" RENAME COLUMN "isOperator" TO "operator"`);
    }
